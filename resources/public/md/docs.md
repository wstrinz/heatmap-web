...
Two middleware functions are provided by default in the `heatmap-web.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `heatmap-web.handler` namespace to manage the enabled middleware.
