...
{{
var G__5672 = cljs.core.pop.call(null,v__$1);
v__$1 = G__5672;
continue;
}
} else
...
{var pred__5676 = cljs.core._EQ_;var expr__5677 = limit;if(cljs.core.truth_(pred__5676.call(null,1,expr__5677)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__5676.call(null,2,expr__5677)))
...
var G__5679 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__5680 = (limit__$1 - 1);
var G__5681 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__5679;
limit__$1 = G__5680;
parts = G__5681;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___5683 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___5683))
{var replacement_5684 = temp__4124__auto___5683;buffer.append([cljs.core.str(replacement_5684)].join(''));
} else
{buffer.append(ch);
}
{
